...
const {registerFaculty}=require('../Controllers/facultyRegister.controller.js')
const  {loginFaculty,logoutFaculty,refreshAccessToken}=require('../Controllers/facultyLogin.controller.js')
