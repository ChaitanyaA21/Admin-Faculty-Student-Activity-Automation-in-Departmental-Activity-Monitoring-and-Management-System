...
const registerFaculty= async (req,res)=>{
    ...
    const {name,email,altEmail,phoneNo,aadharNo,designation,experience,subjects}=req.body
      console.log(name,email,altEmail,phoneNo,aadharNo,designation,experience,subjects);
    ...
    const facultyData = new facultyModel({
        facultyId:facultyIdG,name,email,altEmail,phoneNo,aadharNo,designation,experience
    })
